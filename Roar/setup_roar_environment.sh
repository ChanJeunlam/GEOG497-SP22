...
conda env create -p /storage/work/$USER/conda/envs/geospatial-geog497-sp22 -f ~/GEOG497-SP22/Roar/geospatial-geog497-sp22.yml
...
conda activate /storage/work/$USER/conda/envs/geospatial-geog497-sp22

# install kernel in /storage/home/l/$USER/.local/share/jupyter/kernels/
python -m ipykernel install --user --name geospatial-geog497-sp22
